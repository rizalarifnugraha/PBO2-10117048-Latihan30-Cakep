 ...
 */
package pbo2.pkg10117048.latihan30.cakep;
 ...
 * Nim   : 10117048
 * Kelas : PBO2
 * Deskripsi Program : Program ini menanyakan apakah author kerjakan sendiri
 *                     atau tidak.
 */
public class PBO210117048Latihan30Cakep {
    ...
    public static void main(String[] args) {
        ...
        if (jawaban.equals("YOI")){
            ...
            System.out.print(ANSI_CYAN+ "\n Sing penting paham konsepnyo bro ."
                    + ANSI_RESET);
